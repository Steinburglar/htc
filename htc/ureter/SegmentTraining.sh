...
config_path="/omics/groups/OE0645/internal/data/htcdata/ureter/external/data/testSegment_config.json"

TORCH_USE_CUDA_DSA=1 CUDA_LAUNCH_BLOCKING=1 htc training --model image --config $config_path #make sure the model matches the model you want to use (i.e, image for segmetation, or median_pixel for tissue spectra classification)
